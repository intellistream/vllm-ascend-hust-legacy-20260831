...
LIFECYCLE_INDEX=$2
RUN_DIR=$3
CONTAINER=${4:-source-dev-pr153-pressure-20260802}
PHYSICAL_DEVICE_ID=${PHYSICAL_DEVICE_ID:-4}
PORT=${PORT:-8081}
MODEL_NAME=Qwen/Qwen2.5-14B-Instruct
SCRIPT_DIR=$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)
REQUEST_SET=${REQUEST_SET:-$SCRIPT_DIR/../request_set.json}
...
RUN_ID="pr153-pressure-$RUN_BASENAME"
...
cat >"$RUN_DIR/run-config.json" <<EOF
{
  ...
  "port": $PORT,
  "model": "$MODEL_NAME",
  "device_kv_bytes": 8589934592,
  "cpu_kv_bytes": 17179869184,
  "request_count": 40,
  "request_rate": 1.0,
  "prefix_tokens": 3840,
  "suffix_tokens": 256,
