...
env_variables: dict[str, Callable[[], Any]] = {
    ...
    "VLLM_ASCEND_SIMLLM_UNMATCHED_STORE_MODE": lambda: os.getenv("VLLM_ASCEND_SIMLLM_UNMATCHED_STORE_MODE", "top"),
    "VLLM_ASCEND_SIMLLM_PROFILE": lambda: bool(int(os.getenv("VLLM_ASCEND_SIMLLM_PROFILE", "0"))),
    "VLLM_ASCEND_SIMLLM_PROFILE_INTERVAL": lambda: int(os.getenv("VLLM_ASCEND_SIMLLM_PROFILE_INTERVAL", "20")),
