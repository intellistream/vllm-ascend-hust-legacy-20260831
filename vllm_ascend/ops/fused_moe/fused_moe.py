...
class AscendFusedMoE(FusedMoE):
    ...
    def forward_impl(  # type: ignore[override]
        ...
        routed_out = _EXTRA_CTX.moe_comm_method.finalize(
            ...
            # Current MoERunner performs the final TP reduction after combining
...
# Shared experts are integrated into FusedMoE in the current vLLM runner API.
AscendSharedFusedMoE = AscendFusedMoE
