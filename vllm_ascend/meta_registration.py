...
if not is_310p():
    ...
    register_meta_if_necessary("_C_ascend", "activation_sparse_silu_and_mul_packed_t", activation_sparse_silu_and_mul_packed_t_meta)
    register_meta_if_necessary("_C_ascend", "activation_sparse_silu_and_mul_direct_t", activation_sparse_silu_and_mul_direct_t_meta)
