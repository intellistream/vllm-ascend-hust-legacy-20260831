...
public:
    ...
    struct Params {
        ...
        Params(
            ...
            symmetricPtr(symmetricPtr_), ptrXActiveMask(ptrXActiveMask_),
...
private:
    CATLASS_DEVICE void initBuffer(Params const &params) {
        ...
        const int32_t expertInventory = params.EP * params.expertPerRank + (params.ptrXActiveMask != nullptr ? 1 : 0);
        paddedExpertNumAligned = AlignUp(expertInventory, ALIGN_128);
...
private:
  struct WorkspaceInfo {
        ...
        WorkspaceInfo(const Params & params) {
            ...
            const int64_t maskedExpertIdxSize = params.ptrXActiveMask == nullptr ? 0 :
            ...
            const int64_t countMatrixSize =
                static_cast<int64_t>(params.EP) * params.EP * params.expertPerRank * sizeof(int32_t);
